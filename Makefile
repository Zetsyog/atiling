...
pkgdatadir = $(datadir)/atiling
pkgincludedir = $(includedir)/atiling
pkglibdir = $(libdir)/atiling
pkglibexecdir = $(libexecdir)/atiling
...
CONFIG_CLEAN_FILES = include/atiling/macros.h include/atiling/yacc.h
...
am_atiling_OBJECTS = src/atiling-main.$(OBJEXT) \
	...
	src/atiling-options.$(OBJEXT) src/atiling-pragma.$(OBJEXT) \
	src/atiling-gen.$(OBJEXT)
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(top_srcdir)/autoconf/compile \
	...
	$(top_srcdir)/include/atiling/macros.h.in \
	$(top_srcdir)/include/atiling/yacc.h.in autoconf/compile \
...
ACLOCAL = ${SHELL} /mnt/autoconf/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} /mnt/autoconf/missing autoconf
AUTOHEADER = ${SHELL} /mnt/autoconf/missing autoheader
AUTOMAKE = ${SHELL} /mnt/autoconf/missing automake-1.16
AWK = mawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CLAN_CFLAGS = -I/usr/local//include
CLAN_LDFLAGS = -L/usr/local//lib
CLAN_LIBS = -lclan
CPP = gcc -E
CPPFLAGS = -g -O2
CYGPATH_W = echo
...
LIBS = -lclan -losl 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /mnt/autoconf/missing makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
OSL_CFLAGS = -I/usr/local//include
OSL_LDFLAGS = -L/usr/local//lib
OSL_LIBS = -losl
PACKAGE = atiling
PACKAGE_BUGREPORT = BUG-REPORT-ADDRESS
PACKAGE_NAME = atiling
PACKAGE_STRING = atiling 0.1.0
PACKAGE_TARNAME = atiling
PACKAGE_URL = 
...
install_sh = ${SHELL} /mnt/autoconf/install-sh
...
ATILING_INCLUDES = -I. -I$(top_builddir)/include -I$(top_srcdir)/include
...
include/atiling/yacc.h: $(top_builddir)/config.status $(top_srcdir)/include/atiling/yacc.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
src/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) src/$(DEPDIR)
	@: > src/$(DEPDIR)/$(am__dirstamp)
src/atiling-main.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
...
src/atiling-options.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/atiling-pragma.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/atiling-gen.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)

atiling$(EXEEXT): $(atiling_OBJECTS) $(atiling_DEPENDENCIES) $(EXTRA_atiling_DEPENDENCIES) 
	@rm -f atiling$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(atiling_OBJECTS) $(atiling_LDADD) $(LIBS)
...
include src/$(DEPDIR)/atiling-gen.Po # am--include-marker
...
include src/$(DEPDIR)/atiling-pragma.Po # am--include-marker
...
src/atiling-main.o: src/main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT src/atiling-main.o -MD -MP -MF src/$(DEPDIR)/atiling-main.Tpo -c -o src/atiling-main.o `test -f 'src/main.c' || echo '$(srcdir)/'`src/main.c
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/atiling-main.Tpo src/$(DEPDIR)/atiling-main.Po
#	$(AM_V_CC)source='src/main.c' object='src/atiling-main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o src/atiling-main.o `test -f 'src/main.c' || echo '$(srcdir)/'`src/main.c

src/atiling-main.obj: src/main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT src/atiling-main.obj -MD -MP -MF src/$(DEPDIR)/atiling-main.Tpo -c -o src/atiling-main.obj `if test -f 'src/main.c'; then $(CYGPATH_W) 'src/main.c'; else $(CYGPATH_W) '$(srcdir)/src/main.c'; fi`
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/atiling-main.Tpo src/$(DEPDIR)/atiling-main.Po
#	$(AM_V_CC)source='src/main.c' object='src/atiling-main.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o src/atiling-main.obj `if test -f 'src/main.c'; then $(CYGPATH_W) 'src/main.c'; else $(CYGPATH_W) '$(srcdir)/src/main.c'; fi`

src/atiling-loop_info.o: src/loop_info.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT src/atiling-loop_info.o -MD -MP -MF src/$(DEPDIR)/atiling-loop_info.Tpo -c -o src/atiling-loop_info.o `test -f 'src/loop_info.c' || echo '$(srcdir)/'`src/loop_info.c
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/atiling-loop_info.Tpo src/$(DEPDIR)/atiling-loop_info.Po
#	$(AM_V_CC)source='src/loop_info.c' object='src/atiling-loop_info.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o src/atiling-loop_info.o `test -f 'src/loop_info.c' || echo '$(srcdir)/'`src/loop_info.c

src/atiling-loop_info.obj: src/loop_info.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT src/atiling-loop_info.obj -MD -MP -MF src/$(DEPDIR)/atiling-loop_info.Tpo -c -o src/atiling-loop_info.obj `if test -f 'src/loop_info.c'; then $(CYGPATH_W) 'src/loop_info.c'; else $(CYGPATH_W) '$(srcdir)/src/loop_info.c'; fi`
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/atiling-loop_info.Tpo src/$(DEPDIR)/atiling-loop_info.Po
...
src/atiling-pragma.o: src/pragma.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT src/atiling-pragma.o -MD -MP -MF src/$(DEPDIR)/atiling-pragma.Tpo -c -o src/atiling-pragma.o `test -f 'src/pragma.c' || echo '$(srcdir)/'`src/pragma.c
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/atiling-pragma.Tpo src/$(DEPDIR)/atiling-pragma.Po
#	$(AM_V_CC)source='src/pragma.c' object='src/atiling-pragma.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o src/atiling-pragma.o `test -f 'src/pragma.c' || echo '$(srcdir)/'`src/pragma.c

src/atiling-pragma.obj: src/pragma.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT src/atiling-pragma.obj -MD -MP -MF src/$(DEPDIR)/atiling-pragma.Tpo -c -o src/atiling-pragma.obj `if test -f 'src/pragma.c'; then $(CYGPATH_W) 'src/pragma.c'; else $(CYGPATH_W) '$(srcdir)/src/pragma.c'; fi`
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/atiling-pragma.Tpo src/$(DEPDIR)/atiling-pragma.Po
#	$(AM_V_CC)source='src/pragma.c' object='src/atiling-pragma.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o src/atiling-pragma.obj `if test -f 'src/pragma.c'; then $(CYGPATH_W) 'src/pragma.c'; else $(CYGPATH_W) '$(srcdir)/src/pragma.c'; fi`

src/atiling-gen.o: src/gen.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT src/atiling-gen.o -MD -MP -MF src/$(DEPDIR)/atiling-gen.Tpo -c -o src/atiling-gen.o `test -f 'src/gen.c' || echo '$(srcdir)/'`src/gen.c
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/atiling-gen.Tpo src/$(DEPDIR)/atiling-gen.Po
#	$(AM_V_CC)source='src/gen.c' object='src/atiling-gen.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o src/atiling-gen.o `test -f 'src/gen.c' || echo '$(srcdir)/'`src/gen.c

src/atiling-gen.obj: src/gen.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT src/atiling-gen.obj -MD -MP -MF src/$(DEPDIR)/atiling-gen.Tpo -c -o src/atiling-gen.obj `if test -f 'src/gen.c'; then $(CYGPATH_W) 'src/gen.c'; else $(CYGPATH_W) '$(srcdir)/src/gen.c'; fi`
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/atiling-gen.Tpo src/$(DEPDIR)/atiling-gen.Po
#	$(AM_V_CC)source='src/gen.c' object='src/atiling-gen.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(atiling_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o src/atiling-gen.obj `if test -f 'src/gen.c'; then $(CYGPATH_W) 'src/gen.c'; else $(CYGPATH_W) '$(srcdir)/src/gen.c'; fi`
...
distclean: distclean-am
	...
	-rm -f src/$(DEPDIR)/atiling-gen.Po
	...
	-rm -f src/$(DEPDIR)/atiling-pragma.Po
